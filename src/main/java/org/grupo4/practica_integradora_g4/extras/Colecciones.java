...
public class Colecciones {
    ...
    static {
        ...
        USUARIOSADMIN.put("root",new Usuario("root","admin","admin","","",null,0,null,false,null));
        USUARIOSADMIN.put("pablo",new Usuario("pablo","huerta","huerta","","",null,0,null,false,null));
